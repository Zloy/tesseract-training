= Numbers from screenshots with Tesseract OCR sandbox img[https://github.com/Zloy/tesseract-training/blob/master/samples/pot0007.png]
...
img[https://github.com/Zloy/tesseract-training/blob/master/total.png]
...
That folder contais <b>run.cmd</b> which ocrs total.png.

The result text is in total.txt. You can see errors:
img[https://github.com/Zloy/tesseract-training/blob/master/images/02a.gif]
...
Launch run.cmd to ocr total.png with trained tesseract.

The result text is in total.txt. You can see errors:
img[https://github.com/Zloy/tesseract-training/blob/master/images/03a.gif]
...
The result text is in total.txt. You can see errors:
img[https://github.com/Zloy/tesseract-training/blob/master/images/04a.gif]
...
You can scale total.png different way: <tt>cd exp4 - resized</tt>

It contains <b>total-resized.png</b> the fragment of which you can see below
img[https://github.com/Zloy/tesseract-training/blob/master/images/resized-part.png]

To ocr total-resized launch run.cmd

The result text is in total.txt. You can see errors:
img[https://github.com/Zloy/tesseract-training/blob/master/images/05a.gif]
