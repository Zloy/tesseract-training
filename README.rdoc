...
This repo contains all necessary bits to OCR number images grabbed from the screen (like that http://github.com/Zloy/tesseract-training/raw/master/samples/pot0007.png)
...
http://github.com/Zloy/tesseract-training/raw/master/images/scaled-part.png
